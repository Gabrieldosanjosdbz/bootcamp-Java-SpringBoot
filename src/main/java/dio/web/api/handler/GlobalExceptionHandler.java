...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // Método que cria e retorna cabeçalhos HTTP, configurando o tipo de mídia para JSON.
    ...
    // Método que cria e retorna um objeto ResponseError, encapsulando informações de erro,
    ...
    // Trata exceções gerais (Exception.class). O método verifica se a exceção é uma instância de UndeclaredThrowableException,
