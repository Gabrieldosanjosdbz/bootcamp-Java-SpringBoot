...
public class PredicateExample {
    public static void main(String[] args) {
        ...
        //forma imperativa (isto é uma classe anonima)
        /*
        * Predicate<String> maisDeCincoCaracteres = new Predicate<>(){
        * @Override
        ...
        */
        ...
        palavras.stream()
                .filter(maisDeCincoCaracteres) //ou poderia ser nome -> nome.length() > 5;
